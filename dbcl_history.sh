...
ANALYTICSCONFIGCACHETIMEOUTMILLIS=${14}
...
DATABASECLASS=${33}
DB2ZDATABASECHANGELOGINDEX=${34}
DB2ZDATABASECHANGELOGLOCKINDEX=${35}
DB2ZTRACKINGTABLESLOCATIONDATABASE=${36}
DB2ZTRACKINGTABLESLOCATIONTABLESPACE=${37}
...
docker-entrypoint.sh "${GLOBALS[@]}" dbcl-history "${PARAMS[@]}"
